...
exports.ServiceRefOrValueJoi = void 0;
...
exports.ServiceRefOrValueJoi = {
    '@baseType': Joi.string(),
    '@referredType': Joi.string(),
    '@schemaLocation': Joi.string().uri(),
    '@type': Joi.string().default('ServiceRefOrValue'),
    category: Joi.string(),
    ...
    supportingService: Joi.array().items(Joi.object()),
};
exports.ServiceRefOrValueJoi.supportingService = Joi.array().items(Joi.object(exports.ServiceRefOrValueJoi));
//# sourceMappingURL=ServiceRefOrValue.joi.js.map