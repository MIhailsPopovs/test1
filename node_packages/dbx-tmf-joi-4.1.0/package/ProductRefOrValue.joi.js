...
exports.ProductRefOrValueJoi = void 0;
...
exports.ProductRefOrValueJoi = {
    '@baseType': Joi.string(),
    '@referredType': Joi.string(),
    '@schemaLocation': Joi.string().uri(),
    '@type': Joi.string().default('ProductRefOrValue'),
...
exports.ProductRefOrValueJoi.product = Joi.array().items(Joi.object(exports.ProductRefOrValueJoi));
//# sourceMappingURL=ProductRefOrValue.joi.js.map