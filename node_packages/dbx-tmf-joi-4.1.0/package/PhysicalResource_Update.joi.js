...
exports.PhysicalResource_UpdateJoi = void 0;
...
exports.PhysicalResource_UpdateJoi = {
    '@baseType': Joi.string(),
    '@referredType': Joi.string(),
    '@schemaLocation': Joi.string().uri(),
    '@type': Joi.string().default('PhysicalResource'),
...
//# sourceMappingURL=PhysicalResource_Update.joi.js.map